...
RS_MAX_DIST = 10
RENDER_TRAJ = True
UNPARK_SLOT_BUFFER = 0.3
UNPARK_SUCCESS_IOU = 0.1
UNPARK_IOU_STAGE_THRESHOLDS = (0.8, 0.6, 0.3)
UNPARK_IOU_STAGE_REWARDS = (0.3, 0.6, 1.2)
UNPARK_IOU_PROGRESS_SCALE = 4.0
UNPARK_IMG_MODE = "rgb"
UNPARK_USE_SLOT_CHANNEL = False
UNPARK_PREPARE_STEPS = 40
UNPARK_CONNECT_STRIDE = 2
UNPARK_CONNECT_ATTEMPT_INTERVAL = 3
UNPARK_FORWARD_PROGRESS_WINDOW = 5
UNPARK_FORWARD_PROGRESS_MIN_DELTA = 0.3
UNPARK_CONNECT_MIN_FORWARD_STEPS = 8
UNPARK_CONNECT_DISABLE_NEAR_GOAL_DIST = 2.0
UNPARK_STALL_PROGRESS_MAX_DELTA = 0.15
UNPARK_STALL_MIN_TRAVEL = 0.8
UNPARK_STALL_MAX_NET_PROGRESS_RATIO = 0.45
UNPARK_STALL_CONFIRM_WINDOWS = 2
